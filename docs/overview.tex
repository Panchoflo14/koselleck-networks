...
what the label still says. Separately, roughly half of communities carry
the ``Structural / Uncertain'' lane rather than a topical one (down from
70\% before the resolution was raised, see below), because the corpus is
multilingual (English, Latin, Law French, Welsh, Scots, and more) and
early modern, and a detected community sometimes groups words by shared
grammar or shared language rather than by shared topic. The tool shows
that lane next to the label rather than presenting every label as
equally reliable.
\end{claimbox}
